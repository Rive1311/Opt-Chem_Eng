...
f8=((max(cumsum(x( bp1(1,:)<250)))-10.2)).^2;
f9=((max(cumsum(x( bp1(1,:)<280)))-16)).^2;
f10=((max(cumsum(x( bp1(1,:)<300)))-22.76)).^2;
f11=((max(cumsum(x( bp1(1,:)<314)))-28)).^2;
f12=((max(cumsum(x( bp1(1,:)<325)))-41)).^2;
f13=((max(cumsum(x( bp1(1,:)<350)))-46)).^2;
f14=((max(cumsum(x( bp1(1,:)<375)))-50)).^2;
